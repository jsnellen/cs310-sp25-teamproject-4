...
public class AbsenteeismTest {
    ...
    testAbsenteeismExtraTime() {
        ...
        assertEquals("#8C0644BA (Pay Period Starting 09-09-2018): -5.00%", a2.toString());
        
    }
    
        @Test
    public void 
    testAbsenteeismAutoDeductNeeded() {
        ...
        assertEquals("#2A5620A0 (Pay Period Starting 09-09-2018): 5.00%", a2.toString());
