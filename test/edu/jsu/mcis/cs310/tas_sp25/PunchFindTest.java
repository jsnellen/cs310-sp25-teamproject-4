...
public class PunchFindTest {
    ...
    public void testFindPunches4() {
        ...
        /* Retrieve Punches from Database */
        Punch p10 = punchDAO.find(149);
        Punch p11 = punchDAO.find(153);
        Punch p12 = punchDAO.find(158);

        /* Compare to Expected Values */
        assertEquals("#E77BFAEA CLOCK IN: WED 08/01/2018 06:43:17", p10.printOriginal());
        assertEquals("#0B8C3085 CLOCK IN: WED 08/01/2018 06:48:33", p11.printOriginal());
        assertEquals("#99F0C0FA CLOCK IN: WED 08/01/2018 06:50:57", p12.printOriginal());
    ...
    public void testFindPunches5() {
        ...
        /* Retrieve Punches from Database */
        Punch p13 = punchDAO.find(162);
        Punch p14 = punchDAO.find(171);
        Punch p15 = punchDAO.find(188);

        /* Compare to Expected Values */
        assertEquals("#CEA28723 CLOCK IN: WED 08/01/2018 06:53:24", p13.printOriginal());
        assertEquals("#CEC9A3DA CLOCK OUT: WED 08/01/2018 06:56:23", p14.printOriginal());
        assertEquals("#DD6E2C0C CLOCK IN: WED 08/01/2018 06:59:19", p15.printOriginal());
